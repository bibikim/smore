...
<script>
	...
	$(document).ready(function(){
			...
			callbacks: {
				onImageUpload: function(files){
					...
					for(let i = 0; i < files.length; i++) {
						...
						$.ajax({
							type: 'post',
							url: getContextPath() + '/qnaboard/uploadImage',
							data: formData,
		...
		$('#btn_list').click(function(){
			location.href = getContextPath() + '/qnaboard/list';
		});
...
<div>
	...
	<form id="frm_edit" action="${contextPath}/qnaboard/modify" method="post">
		...
		<div>
			...
			<textarea name="content" id="content">${qnaboard.content}</textarea>				
		</div>
